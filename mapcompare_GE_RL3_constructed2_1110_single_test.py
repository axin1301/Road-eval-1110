...
def mapcompare_d500_first_update_new(fgt,fd,fr,county,radius):
    ...
    if not os.path.exists('../output2_GE_directly_add_RL3_constructed2_four_kinds/'):
        os.makedirs('../output2_GE_directly_add_RL3_constructed2_four_kinds/')
    df.to_csv('../output2_GE_directly_add_RL3_constructed2_four_kinds/'+county+'_'+str(i)+'_test.csv', index=False)
...
def main():
    ...
    # ['130631', '131123', '131122', '141034', '130925', '131128', '341203', '131124', '130434', '522635']:#['610328', '130533', '130529', '130532', '130531'][:2]:#['130522']:#['610328', '130533', '130529', '130532', '130531', '130631', '131123', '131122', '141034', '130925', '131128', '341203', '131124', '130434', '522635']:#['130522']:#district_list:
        print(county)
        if os.path.exists('../output2_GE_directly_add_RL3_constructed2_four_kinds/'+county+'_'+str(0.01)+'_test.csv'):
            continue
        ...
        fd = '../GraphSamplingToolkit-main_improve_GE_combined_full_four_kinds/'+county+'/xyx_0'+'/algorithm/'+county+'_pred'
        # fd = 'GraphSamplingToolkit-main_improve_GE/'+district+str(zoom)+'_'+str(k_size)+'/algorithm/xyx_'+str(radius)+'/'+district+'_'+str(year)
        
        fr = '../GraphSamplingToolkit-main_improve_GE_combined_full_four_kinds/'+county+'/xyx_0'+'/evals/'+county
        ...
        if not os.path.exists('../GraphSamplingToolkit-main_improve_GE/'+county+'/xyx_0/groundtruth/'+county+'_groundtruth_txt_edges_osm.txt'):
            continue
        if not os.path.exists('../GraphSamplingToolkit-main_improve_GE_combined_full_four_kinds/'+county+'/xyx_0/algorithm/'+county+'_pred_edges.txt'):
            continue
        if os.path.getsize('../GraphSamplingToolkit-main_improve_GE/'+county+'/xyx_0/groundtruth/'+county+'_groundtruth_txt_edges_osm.txt') == 0:
            continue
        if os.path.getsize('../GraphSamplingToolkit-main_improve_GE_combined_full_four_kinds/'+county+'/xyx_0/algorithm/'+county+'_pred_edges.txt') == 0:
            continue
